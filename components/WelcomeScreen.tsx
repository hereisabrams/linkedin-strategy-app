      ...
      <div className="max-w-3xl">
        ...
        <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-6">
          <button
            ...
            className="rounded-md bg-slate-700 px-6 py-3 text-lg font-semibold text-white shadow-sm hover:bg-slate-600 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-slate-500 transition-colors w-full sm:w-auto"
          >
            Continue as Guest
          </button>
        ...
        <p className="text-xs text-gray-500 mt-10">Sign in with Google to sync your strategy across devices.</p>
      </div>
    </div>
  );
};
